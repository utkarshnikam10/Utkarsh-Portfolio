 ...
 * Features: scroll-aware background, active link highlighting, hamburger menu
 */
export default function Navbar() {
  const [scrolled, setScrolled] = useState(false);
  const { navOpen, setNavOpen, activeSection } = useStore();
    ...
    <>
      <header className={`navbar ${scrolled ? "scrolled" : ""}`}>
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          {/* Right side: social + theme + hamburger */}
          <div className="flex items-center gap-4">
            ...
            >
              <span
                className={`w-5 h-0.5 bg-text-secondary transition-all duration-350 ${
